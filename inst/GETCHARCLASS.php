...
class GETCHARCLASS {
    ...
    */
    public static function getcharFunc(  int &$instPoint,array &$instArr, array &$VarList,
        ...
        // takes op2 as string and op3 as int, and save char from 
        // op2 on index op3 as string to op1
        ...
        //getchar
        $len = strlen((string)$valForPar1);
        if ($valForPar2 >= strlen((string)$valForPar1)) { 
            //len is larger than string len 
            throw new StringOperationException();
        }elseif (($typeForPar1 === "string") && ($typeForPar2 === "int")) {
            $resultPar = ((string)$valForPar1)[(int)$valForPar2];
        }else{
            //not correct types 
            throw new OperandTypeException();
        } 
