...
class SUBCLASS {
    ...
    */
    public static function subFunc(  int &$instPoint,array &$instArr, array &$VarList,
        ...
        //load operand, check their types, do sub
        ...
        $resultSub = (int)$valForSub1 - (int)$valForSub2;
