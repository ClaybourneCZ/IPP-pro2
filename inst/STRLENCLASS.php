...
class STRLENCLASS {
    ...
    */
    public static function strlenFunc(  int &$instPoint,array &$instArr, array &$VarList,
        ...
        // takes op2 as string and saves op2 lenght as int to op1
        ...
        if (($typeForPar1 === "string")) {
            $resultPar = strlen((string)$valForPar1);
        }else{
            //not correct types 
            throw new OperandTypeException();
        } 
