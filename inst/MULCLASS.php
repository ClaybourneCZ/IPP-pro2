...
class MULCLASS {
    ...
    */
    public static function mulFunc(  int &$instPoint,array &$instArr, array &$VarList,
        ...
        // load operands, check their types, do *
        ...
        $resultMul = (int)$valForMul1 * (int)$valForMul2;
