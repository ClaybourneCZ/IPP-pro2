...
class JUMPIFNEQCLASS {
    ...
    */
    public static function jumpifneqFunc(  int &$instPoint,array &$instArr, array &$VarList,
        ...
        // jumps to op1 as label if op2 and op3 are not same types and values
