...
class WRITECLASS {
    ...
    */
    public static function writeFunc(  int &$instPoint,array &$instArr, array &$VarList,
        ...
        // takes op1 and write its value as its type to stdout
        ...
        if($typeForPar1 === "string"){
            $stdout->writeString((string)$valForPar1);
        } elseif($typeForPar1 === "int") {
            $stdout->writeInt((int)$valForPar1);
        } elseif($typeForPar1 === "bool") {
            $stdout->writeBool((bool)$valForPar1);
        } elseif($typeForPar1 === "float") {
            $stdout->writeFloat((float)$valForPar1);
        } elseif($typeForPar1 === "nil") {
            //should be empty string for nil
            $stdout->writeString((string)$valForPar1);
        } else {
